...
const numberOfHearts = 20; // Поменя на свое значение. Количество сердец на первом шаге
const secondStepWords = ["Рефрежератор", "Автомобиль", "Эволюция", "Валентинка"]; // Массив слов для второго шага

const quizQuestions = [ // Массив вопросов для третьего шага
    {
        question: "Какой твой любимый цвет?",
        options: ["Красный", "Синий", "Зеленый", "Розовый"],
    ...
    {
        question: "Что бы ты выбрала для идеального свидания?",
        options: ["Поход в кино", "Аквапарк", "Ужин в ресторане", "Прогулка по городу"],
        correctAnswer: "Аквапарк"
    }
];

const valentinText = "Эта валентинка для моей любимой!Ты у меня самая лучшая,с тобой каждый мой день становится особенным<3" // Текст для финального шага
